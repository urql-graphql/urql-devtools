...
- add uploading source code instructions [\#385](https://github.com/FormidableLabs/urql-devtools/pull/385) ([JoviDeCroock](https://github.com/JoviDeCroock))
- add entry about producing final build [\#384](https://github.com/FormidableLabs/urql-devtools/pull/384) ([JoviDeCroock](https://github.com/JoviDeCroock))
- \(chore\) - document setup process [\#383](https://github.com/FormidableLabs/urql-devtools/pull/383) ([JoviDeCroock](https://github.com/JoviDeCroock))
- fix: Allows urql-devtools to launch via Windows PowerShell [\#378](https://github.com/FormidableLabs/urql-devtools/pull/378) ([jakobo](https://github.com/jakobo))
